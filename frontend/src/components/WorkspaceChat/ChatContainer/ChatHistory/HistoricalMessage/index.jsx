...
const HistoricalMessage = ({
  ...
  return (
    ...
    >
      <div className={`py-8 px-4 w-full flex gap-x-5 md:max-w-[80%]`}>
        <div className="flex gap-x-5">
          <div className="flex flex-col items-center">
            <div className="mt-1 -mb-10 flex-row-reverse">
              <ProfileImage role={role} workspace={workspace} />
              <TTSMessage
                slug={workspace?.slug}
                chatId={chatId}
...
function ProfileImage({ role, workspace }) {
  ...
  if (role === "assistant") {
    return (
      <div className="relative w-[35px] h-[35px] flex-shrink-0 overflow-hidden">
        <img

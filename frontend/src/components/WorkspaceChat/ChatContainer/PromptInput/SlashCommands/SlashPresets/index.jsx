    ...
    <>
      {presets.map((preset) => (
        ...
        >
          <div className="w-full flex-col text-left flex pointer-events-none">
            <div className="text-[#FFCB02] text-sm font-bold">
              {preset.command}
            </div>
            <div className="text-[#FFCB02] text-opacity-60 text-sm">
              {preset.description}
            </div>
          </div>
          <button
            ...
            className="text-[#FFCB02] text-sm p-1 hover:cursor-pointer hover:bg-zinc-900 rounded-full mt-1"
          >
      ...
      >
        <div className="w-full flex-row flex pointer-events-none items-center gap-2">
          ...
          <div className="text-[#FFCB02] text-sm font-medium">
            Add New Preset{" "}
          </div>
        </div>
      </button>

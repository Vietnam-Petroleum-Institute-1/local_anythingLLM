          ...
          >
            ...
            >
              ...
              transition-all duration-[200ms]
                flex flex-grow w-[75%] gap-x-2 py-[6px] px-[12px] rounded-[4px] text-[#FFCB02] justify-start items-center
                hover:bg-workspace-item-selected-gradient hover:font-bold border-2 border-[#FFCB02]
                ${isActive ? "bg-[#1A3B5A]" : ""}`}
              >
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <p
                      className={`text-[14px] leading-loose whitespace-nowrap overflow-hidden ${
                        isActive ? "text-[#FFFFFF] " : "text-zinc-200"
                      }`}
                    >
                      {isActive || isHovered

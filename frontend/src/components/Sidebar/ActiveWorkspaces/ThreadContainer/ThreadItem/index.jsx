  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`${
          isActive
            ? "border-l-2 border-b-2 border-yellow-100"
            : "border-l border-b border-yellow-500"
        ...
        <div
          ...
          className={`${
            idx <= activeIdx && !isActive
              ? "border-l-2 border-yellow-200"
              : "border-l border-yellow-100"
        ...
        {thread.deleted ? (
          <div className="w-full flex justify-between">
            <div className="w-full ">
              <p className={`text-left text-[#FFCB02]`}>deleted thread</p>
            </div>
            {ctrlPressed && (
              <button
                type="button"
              ...
              >
                <ArrowCounterClockwise
                  className="text-[#FFCB02] hover:text-white"
                  size={18}
                />
              </button>
            )}
          ...
          >
            <p
              className={`text-left text-sm ${
                isActive ? "font-medium text-[#FFCB02]" : "text-yellow-600"
              }`}
            >
          ...
          <div ref={optionsContainer}>
            {ctrlPressed ? (
              ...
              <div className="flex items-center w-fit group-hover:visible md:invisible gap-x-1">
                ...
                >
                  <DotsThree className="text-[#FFCB02]" size={25} />
                </button>
              </div>
            )}
            {showOptions && (

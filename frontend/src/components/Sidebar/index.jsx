...
export default function Sidebar() {
  ...
  return (
    <div>
      <Link
        to={paths.home()}
        className="flex shrink-0 max-w-[55%] items-center justify-start mx-[60px] my-[18px]"
        aria-label="Home"
      >
        <img
          src={logo}
      ...
      <div
        ref={sidebarRef}
        className="relative m-[16px] rounded-[16px] bg-[#00274C] border-2 border-[#FFCB02] min-w-[250px] p-[10px] h-[calc(70%-40px)]"
      >
                ...
                <div className="flex gap-x-2 items-center justify-between">
                  {(!user || user?.role !== "default") && (
                    <button
                      ...
                      className="flex flex-grow w-[75%] h-[44px] gap-x-2 py-[5px] px-2.5 mb-2 bg-[#012241] rounded-[8px] text-[#FFCB02] justify-center items-center hover:bg-opacity-80 transition-all duration-300"
                    >
                      <Plus size={18} weight="bold" />
                      <p className="text-[#FFCB02] text-sm font-semibold">
        ...
        >
          <div className="w-full h-full flex flex-col overflow-x-hidden items-between">
            ...
            <div className="flex w-full items-center justify-between gap-x-4">
              ...
              {(!user || user?.role !== "default") && (
                <div className="flex gap-x-2 items-center text-[#FFCB02] shink-0">
                  <SettingsButton />
                </div>
              )}
            </div>
